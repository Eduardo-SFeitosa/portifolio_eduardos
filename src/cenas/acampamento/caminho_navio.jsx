...
export default function Caminho_navio({tamanho, cor, posicao, nome, progresso_total, progresso_minimo, progresso_maximo}) {
    ...
    return <group key={nome}>
            ...
            <group 
                ...
                <sprite position={[posicao[0] + tamanho_x / 2 * escala_x, posicao[1], posicao[2] + .5]} scale={[1.5, 1.5, 1]}>
                    <spriteMaterial
                        map={textura_barco}
                        transparent
                        color={cor}
